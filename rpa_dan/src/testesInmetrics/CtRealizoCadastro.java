...
public class CtRealizoCadastro {
	...
	public static void main(String[] args) {				
		...
		ct.clicoCadastreSe();
		System.out.println("E é apresentado a tela de cadastro");	
		ct.validaTelaCadastro();	
		System.out.println("E Preencho os campo Usuario, Senha & Confirmo a Senha com usuario já cadastrado");	
		ct.preenchoCamposUsuarioSenhaCadastro("Duplicado");
		System.out.println("E clico em cadastrar");	
		ct.clicoBotaoCadastrar();
		System.out.println("Então é apresentado a memsagem Usuário já cadastrado");	
